<div class="mt-6">
    <div
        ...
        <div>
            <h1 class="text-3xl font-extrabold text-gray-300">Let's Talk</h1>
            <p class="mt-4 text-sm text-gray-500">Have some big idea or brand to develop and need help? Then reach out
                we'd love to hear about your project and provide help.</p>

            <div class="mt-12">
                <h2 class="text-base font-bold text-gray-800">Email</h2>
                <ul class="mt-4">
                    <li class="flex items-center">
                        <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill='#042f2e'
                        ...
                        <a href="javascript:void(0)" class="ml-4 text-sm text-gray-300">
            ...
            <div class="mt-12">
                <h2 class="text-base font-bold text-gray-800">Socials</h2>
